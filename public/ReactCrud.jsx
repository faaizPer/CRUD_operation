...
var StudentAll = React.createClass({   
    ...
    getInitialState: function () {  
      return { name: '' ,address: '',email:'',contact:'',age:'',id:'',Buttontxt:'Save', data1: []};  
    },  
  ...
  DeleteData(id){  
    var studentDelete = {  
      ...
      EditData(item){           
     this.setState({name: item.name,address:item.address,contact:item.contact,email:item.email,age:item.age,id:item._id,Buttontxt:'Update'});  
       },  
    ...
    render: function() {  
      return (   
        <div  className="container"  style={{marginTop:'50px'}}>  
         <p className="text-center" style={{fontSize:'25px'}}><b> Registeration</b></p>  
    <form>  
  ...
  <div className="col-sm-12 col-md-12 "  style={{marginTop:'50px',marginLeft:'300px'}} >  
   ...
   <table className="table-bordered"><tbody>  
     <tr><th><b>S.No</b></th><th><b>NAME</b></th><th><b>ADDRESS</b></th><th><b>EMAIL</b></th><th><b>CONTACT</b><b>AGE</b></th><th><b>Edit</b></th><th><b>Delete</b></th></tr>  
